...
import { useCanister, useDialog } from '@connect2ic/react';
...
const SwapContainer = ({ data }) => {
    ...
    return (
        <>
            ...
            <SectionTitle>Start trading your <span style={{ color: "#d3b872" }}>GLDNFTs</span> now !</SectionTitle>
            <SwapCard>
                <Title>Swap your <Mark >GLDNFT</Mark> for <Mark>GLDT</Mark></Title>
                <SwapModalContentContainer sx={{ display: 'flex', alignItems: "center", }}>
                    <GLDNFT>
                        <ValueContainer>  {total}<span style={{ fontSize: "24px" }}>g </span>  <Mark style={{
                            fontWeight: 600,
                            display: 'block'
                        }}>GLDNFT</Mark> </ValueContainer>
                    </GLDNFT>
                    <LeftArrow>→</LeftArrow>
                    <GLDT>
                        <ValueContainer>{total * 100} <Mark style={{
                            fontWeight: 600,
                            display: 'block'
                        }}>{data.outputCurrency}</Mark> </ValueContainer>
                    </GLDT>
