...
export const getGoldTimeserie = async () => {
    const start_date = formatDate(Date.now() - yearTimestamp)
    const end_date = formatDate(Date.now() - dayTimestamp)
    console.log('Date.now()) - yearTimestamp', formatDate(Date.now() - yearTimestamp))
    console.log('Date.now() - dayTimestamp', formatDate(Date.now() - dayTimestamp))
