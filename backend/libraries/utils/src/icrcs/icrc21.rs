...
pub fn create_consent_info(
    ...
    metadata: icrc21_canister_call_consent_message::icrc21_consent_message_metadata,
) -> icrc21_canister_call_consent_message::Response {
    let fields_message =
        icrc21_canister_call_consent_message::icrc21_field_display_message { intent, fields };

    let consent_message = icrc21_canister_call_consent_message::icrc21_consent_message {
        generic_display_message: generic_message,
        fields_display_message: fields_message,
    };

    let consent_info = icrc21_canister_call_consent_message::icrc21_consent_info {
        consent_message,
        metadata,
    };

    icrc21_canister_call_consent_message::Response::Ok(consent_info)
}

pub fn create_error_response(
    description: String,
) -> icrc21_canister_call_consent_message::Response {
    let error_info = icrc21_canister_call_consent_message::icrc21_error_info { description };
    icrc21_canister_call_consent_message::Response::Err(
        icrc21_canister_call_consent_message::icrc21_error::UnsupportedCanisterCall(error_info),
    )
}

pub fn handle_unsupported_method(
    args: icrc21_canister_call_consent_message::Args,
) -> icrc21_canister_call_consent_message::Response {
