...
use types::{BuildVersion, CanisterWasmCM, Empty, UpgradeCanisterWasmArgs, UpgradesFilter};
...
where
    ...
    T::Target: Serialize,
{
    serde_json::to_string_pretty(&value.to_human_readable())
...
impl From<&CanisterWasmCM> for CanisterWasmTrimmed {
