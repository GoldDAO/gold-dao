...
#[derive(CandidType, Deserialize)]
pub struct ArchiveGetBlocksArgs {
    pub start: ArchiveBlockIndex,
    pub length: u64,
}

#[derive(CandidType, Deserialize)]
pub enum ArchiveGetBlocksResult {
    Ok(ArchiveBlockRange),
    Err(ArchiveGetBlocksError),
}
