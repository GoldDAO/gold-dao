...
mod tests {
    ...
    fn test_update_proposals_metrics() {
        ...
        read_state(|state| {
            assert_eq!(
                state.data.voting_participation_history.get(&1),
                Some(2600u64)
            );
        });
        ...
        read_state(|state| {
            assert_eq!(
                state.data.voting_participation_history.get(&2),
                Some(4000u64)
            );
        });
        ...
        read_state(|state| {
            assert_eq!(
                state.data.voting_participation_history.get(&3),
                Some(5500u64)
            );
        });
        ...
        read_state(|state| {
            assert_eq!(
                state.data.voting_participation_history.get(&4),
                Some(6000u64)
            );
        });
    }
