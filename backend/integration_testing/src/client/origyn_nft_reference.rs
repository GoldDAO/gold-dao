...
use crate::{
    generate_pocket_query_call, generate_pocket_update_call, generate_update_call_encoded_args,
};
use candid::Int;
...
generate_update_call_encoded_args!(stage_library_nft_origyn);
generate_update_call_encoded_args!(manage_storage_nft_origyn);
generate_update_call_encoded_args!(collection_update_nft_origyn);
generate_update_call_encoded_args!(mint_nft_origyn);
generate_update_call_encoded_args!(icrc7_approve);
...
generate_pocket_query_call!(icrc7_max_approvals_per_token_or_collection);
generate_pocket_query_call!(icrc7_max_memo_size);
generate_pocket_query_call!(icrc7_max_query_batch_size);
generate_pocket_query_call!(icrc7_max_revoke_approvals);
...
generate_pocket_query_call!(icrc7_supported_standards);
...
generate_update_call_encoded_args!(icrc7_transfer);
generate_pocket_query_call!(icrc7_transfer_fee);
generate_pocket_query_call!(icrc7_tx_window);
generate_pocket_query_call!(get_token_id_as_nat);
generate_pocket_query_call!(collection_nft_origyn);
generate_update_call_encoded_args!(market_transfer_nft_origyn_batch);
generate_update_call_encoded_args!(market_transfer_nft_origyn);
generate_pocket_query_call!(nft_origyn);
generate_pocket_query_call!(sale_info_nft_origyn);
generate_update_call_encoded_args!(__set_time_mode);
generate_pocket_update_call!(__advance_time);
generate_pocket_update_call!(sale_nft_origyn);
...
pub mod __advance_time {
    use super::*;
    pub type Args = Int;
    pub type Response = Int;
}
pub mod __set_time_mode {
    use super::*;
    pub type Args = NftCanisterSetTimeModeArg;
