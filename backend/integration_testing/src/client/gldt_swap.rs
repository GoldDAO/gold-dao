...
generate_pocket_query_call!(get_swap);
generate_pocket_query_call!(get_historic_swaps);
...
generate_pocket_query_call!(get_history_total);
generate_pocket_query_call!(get_historic_swaps_by_user);
