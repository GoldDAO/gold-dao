use crate::client::origyn_nft::finalize_upload;
use crate::client::origyn_nft::init_upload;
use crate::client::origyn_nft::mint;
use crate::client::origyn_nft::store_chunk;
...
use origyn_nft_canister::finalize_upload;
use origyn_nft_canister::init_upload;
use origyn_nft_canister::mint::Args as MintArgs;
use origyn_nft_canister::mint::MintRequest;
use origyn_nft_canister::mint::Response as MintResponse;
use origyn_nft_canister::store_chunk;
...
pub fn setup_core_canister(
    ...
    let core_nft_wasm = ORIGYN_NFT.clone();
