use crate::gldt_swap_index_suite::setup::setup_gldt_ledger::setup_gldt_ledger;
use crate::gldt_swap_index_suite::setup::setup_gldt_swap::setup_gldt_swap_canister;
use crate::gldt_swap_index_suite::setup::setup_index::setup_index_canister;
...
impl Default for TestEnvBuilder {
    fn default() -> Self {
        Self {
            ...
            // TODO: fix with real one
            index_canister_id: Principal::from_text("ufxgi-4p777-77774-qaadq-cai").unwrap(),
        }
    }
}
