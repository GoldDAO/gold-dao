...
use utils::consts::ICP_LEDGER_CANISTER_ID_STAGING;

use crate::{
    create_ledger_canisters::create_ledger_canisters,
    sns_init_payload::create_weekly_sns_canister_data,
    Args,
    GetNeuronRequest,
};
...
fn synchronise_neurons_happy_path() {
    ...
    let (icp_ledger_canister, ogy_ledger_canister_id, gldgov_ledger_canister_id) =
        create_ledger_canisters(&pic, master_principal);
    // ********************************
