    ...
    <div className='flex justify-between items-center'>
      <div className='text-xl md:text-2xl font-light'>
        <div className='flex items-baseline gap-1'>
          ...
          <div className='text-neutral-900/60 dark:text-neutral-50/60 text-sm'>{token}</div>
        </div>
      </div>
      <Card.Link
        href={`${baseLink}${
          token !== 'ICP'
            ...
            : AccountIdentifier.fromPrincipal({
                ...
                subAccount: SubAccount.fromBytes(hexStringToUint8Array(account?.subaccount)),
              }).toHex()
        }`}
      />
    </div>
  ...
  const TOKENS = [
    {
      ...
      baseLink: 'https://dashboard.internetcomputer.org/sns/tw2vt-hqaaa-aaaaq-aab6a-cai/account/',
    },
    {
      name: 'ICP',
    ...
    },
    {
      ...
      baseLink: 'https://dashboard.internetcomputer.org/sns/leu43-oiaaa-aaaaq-aadgq-cai/account/',
    },
  ];
