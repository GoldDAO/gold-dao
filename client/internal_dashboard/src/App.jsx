...
function App() {
  ...
  return (
    <div className='xl:container mx-4 xl:mx-auto my-16'>
      <div className='flex justify-end items-center mb-8 xl:mb-16'>
      ...
      <div className='mt-8 md:mt-16'>
        <h3 className='text-lg md:text-xl xl:text-2xl mb-4 md:mb-8'>Rewards pool</h3>
        <RewardsPool env={env} />
      </div>

      <div className='mt-8 md:mt-16'>
        <h3 className='text-lg md:text-xl xl:text-2xl mb-4 md:mb-8'>Stake positions</h3>
        <StakePositions env={env} />
      </div>

      <div className='mt-8 md:mt-16'>
        <h3 className='text-lg md:text-xl xl:text-2xl mb-4 md:mb-8'>APY history</h3>
        <ApyHistory env={env} />
      </div>
    </div>
  );
