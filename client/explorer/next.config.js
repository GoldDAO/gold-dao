...
const GLDT_LEDGER_INDEXER = process.env.NETWORK ?
    InternalCanisterIds.gldt_ledger_indexer[canisterKey] :
    GeneratedLocalCanisterIds.gldt_ledger_indexer[canisterKey];
