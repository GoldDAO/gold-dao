...
- Minor UI improvements and wordings

### [1.2.0] - 2026-01-22

### Changed

- Refined landing page messaging to align with GLDT’s current direction following the move to Origyn
...
- Hero animation not loading
- GLDT USD price not fetched from API
...
- GLDT transaction fee from 0.01 to 0.1
