...
const Details = ({ data }: { data: SwapData }) => {
  return (
    <div className="border border-border rounded-xl bg-surface p-4 md:p-6">
      ...
      <div className="flex justify-between items-center border-b border-border py-4">
        <div className="font-semibold text-content/60 min-w-32">Date/Hour</div>
      ...
      <div className="border-b border-border py-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="font-semibold text-content/60">{data.nft_value}g</div>
        </div>
        <div className="flex justify-between items-center">
          <div className="text-sm text-content/60">Serial number</div>
          <div className="text-sm text-content/60">{data.nft_id_string}</div>
        </div>
      </div>

      <div className="flex justify-between items-center py-4">
        <div className="font-semibold text-content/60">Amount to be minted</div>
        <div className="font-semibold text-content/60">
      ...
      {data.type !== "forward" && (
        <div className="flex justify-between items-center border-t border-border py-4">
          <div className="font-semibold text-content/60">Conversion fee</div>
