...
const GoldDAOChart = () => {
  ...
  return (
    <div
      ...
      className="relative w-full h-full flex flex-col items-center justify-center bg-cover bg-center pb-20"
    >
      ...
      <div className="border border-[#E8E6E1] w-[90%] md:w-3/4 rounded-xl p-2 md:p-4 items-center justify-center bg-white md:max-h-[538px] xl:h-[450px] 2xl:h-[500px] 3xl:h-[538px]">
        ...
        <div className="flex flex-row md:flex-row items-center justify-around pt-4 md:pt-0 md:space-y-0">
          <div className="md:absolute bottom-6 right-[50.25%] flex md:w-1/6 bg-white rounded-[20px] border-[#E8E6E1] border shadow-xl px-6 py-4 flex-col justify-center items-center gap-1 flex-shrink-0">
          ...
          <div className="md:absolute bottom-6 left-[50.25%] flex md:w-1/6 bg-white rounded-[20px] border-[#E8E6E1] border shadow-xl px-6 py-4 flex-col justify-center items-center gap-1 flex-shrink-0">
            <div className="flex flex-col items-center justify-center">
