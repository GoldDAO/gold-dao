...
export type DIP721TokensListMetadata =
  | { Ok: Array<bigint> }
  | { Err: NftError };
export type DIP721TokensMetadata =
...
export type EXTBearerResult =
  | { ok: EXTAccountIdentifier }
  | { err: EXTCommonError };
export type EXTCommonError =
...
export type ManageStorageResult =
...
export type StageLibraryResult =
...
export type StorageMetricsResult =
  | { ok: StorageMetrics }
  | { err: OrigynError };
...
export interface _SERVICE {
  ...
  back_up: ActorMethod<
    [bigint],
    { eof: NFTBackupChunk } | { data: NFTBackupChunk }
  >;
