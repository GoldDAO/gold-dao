...
const NFTSelect = ({
  ...
  return (
    <div className={className}>
      <div
        className={clsx(
          "bg-surface-secondary grid grid-cols-3 gap-4 py-3 px-4 rounded-xl border border-border"
        )}
      >
        ...
        <div className="flex justify-between items-center border border-border bg-surface-primary px-1 rounded-lg">
          <BtnSelect
            handleOnClick={() =>
