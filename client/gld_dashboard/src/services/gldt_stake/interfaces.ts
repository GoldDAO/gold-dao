...
export interface Args_3 { 'limit': [] | [bigint], 'starting_week': bigint }
...
export type Args_6 = { 'Upgrade': UpgradeArgs } |
{ 'Init': InitArgs };
...
export type RewardRoundStatus = { 'RewardsClaimed': null } |
{ 'RewardsAllocated': null } |
{ 'AllocationInProgress': null };
...
export interface _SERVICE {
  ...
  'get_historic_position_by_id': ActorMethod<
    [bigint],
    [] | [StakePositionResponse]
  >,
  'get_historic_positions_by_user': ActorMethod<
    [Args_4],
    Array<StakePositionResponse>
  >,
  'get_historic_positions_total_by_user': ActorMethod<
    [[] | [Principal]],
    bigint
  >,
  'get_neurons': ActorMethod<[null], Array<Neuron>>,
  'get_position_by_id': ActorMethod<[bigint], [] | [StakePositionResponse]>,
  'get_reward_rounds': ActorMethod<[null], Array<RewardRound>>,
  'get_total_allocated_rewards': ActorMethod<[null], Array<[string, bigint]>>,
  'get_total_staked': ActorMethod<[null], bigint>,
  'manage_sns_neuron': ActorMethod<[Args_5], Response>,
