...
export interface _SERVICE {
  ...
  get_all_rewards_history: ActorMethod<
    [Args_1],
    Array<[bigint, Array<[TokenSymbol, bigint]>]>
  >;
  ...
  get_proposal_votes_of_neuron: ActorMethod<
    [Args_3],
    Array<[ProposalId, number, VoteType]>
  >;
  get_total_allocated_rewards: ActorMethod<
    [null],
    Array<[TokenSymbol, bigint]>
  >;
  ...
  unallocated_rewards_balance: ActorMethod<
    [null],
    Array<[TokenSymbol, Result_4]>
  >;
}
