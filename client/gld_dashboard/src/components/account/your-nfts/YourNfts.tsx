...
const CardNFT = ({
  ...
  return (
    <div className={className}>
      <div className="border border-border bg-surface-secondary p-6 rounded-xl">
        <div className="flex justify-center sm:justify-between items-center">
          <div className="flex items-center gap-4">
            <div className="bg-accent text-white text-sm rounded-md px-2 py-1 font-semibold">
              {countNFT}
            </div>
...
const YourNfts = ({ className }: { className?: string }) => {
  ...
  return (
    <div className={className}>
      <div className="border border-border bg-surface-primary-1 p-6 rounded-xl">
