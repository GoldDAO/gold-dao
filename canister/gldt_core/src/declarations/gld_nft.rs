...
pub enum Nft_Canister___set_time_mode_arg0 { test, standard }
...
pub enum Account {
  ...
  account{ owner: Principal, sub_account: Option<serde_bytes::ByteBuf> },
}
...
#[derive(CandidType, Deserialize)]
pub enum TokenSpec__1 { ic(ICTokenSpec__1), extensible(Box<CandyShared>) }
...
#[derive(CandidType, Deserialize)]
pub enum TokenSpec { ic(ICTokenSpec), extensible(Box<CandyShared>) }
...
#[derive(CandidType, Deserialize)]
pub enum AskFeature_min_increase { amount(candid::Nat), percentage(f64) }
...
#[derive(CandidType, Deserialize)]
pub enum DutchParams_decay_type { flat(candid::Nat), percent(f64) }
...
#[derive(CandidType, Deserialize)]
pub enum AskFeature_ending { date(candid::Int), timeout(candid::Nat) }
...
pub enum AskFeature {
  ...
  wait_for_quiet{ max: candid::Nat, fade: f64, extension: u64 },
  reserve(candid::Nat),
...
#[derive(CandidType, Deserialize)]
pub enum AuctionConfig_min_increase { amount(candid::Nat), percentage(f64) }
...
pub enum TransactionRecord_txn_type {
  ...
  canister_network_updated{ network: Principal, extensible: Box<CandyShared> },
  escrow_withdraw{
    fee: candid::Nat,
    token: TokenSpec,
    token_id: String,
  ...
  burn{ from: Option<Account__1>, extensible: Box<CandyShared> },
  data{
  ...
  canister_owner_updated{ owner: Principal, extensible: Box<CandyShared> },
  sale_withdraw{
    fee: candid::Nat,
    token: TokenSpec,
    token_id: String,
...
#[derive(CandidType, Deserialize)]
pub enum AuctionStateShared_status { closed, open, not_started }
...
#[derive(CandidType, Deserialize)]
pub enum AuctionConfig__1_min_increase { amount(candid::Nat), percentage(f64) }
...
#[derive(CandidType, Deserialize)]
pub enum SaleStatusShared_sale_type { auction(AuctionStateShared) }
...
#[derive(CandidType, Deserialize)]
pub enum Nft_Canister_back_up_ret0 { eof(NFTBackupChunk), data(NFTBackupChunk) }

pub type EXTTokenIdentifier = String;
#[derive(CandidType, Deserialize)]
pub enum EXTUser { principal(Principal), address(String) }

#[derive(CandidType, Deserialize)]
pub struct EXTBalanceRequest { token: EXTTokenIdentifier, user: EXTUser }

pub type EXTBalance = candid::Nat;
#[derive(CandidType, Deserialize)]
pub enum EXTCommonError { InvalidToken(EXTTokenIdentifier), Other(String) }

#[derive(CandidType, Deserialize)]
pub enum EXTBalanceResult { ok(EXTBalance), err(EXTCommonError) }
...
#[derive(CandidType, Deserialize)]
pub enum BalanceResult { ok(BalanceResponse), err(OrigynError) }

pub type EXTAccountIdentifier = String;
#[derive(CandidType, Deserialize)]
pub enum EXTBearerResult { ok(EXTAccountIdentifier), err(EXTCommonError) }

#[derive(CandidType, Deserialize)]
pub enum BearerResult { ok(Account), err(OrigynError) }

pub type canister_id = Principal;
#[derive(CandidType, Deserialize)]
pub struct Nft_Canister_canister_status_arg0 { canister_id: canister_id }
...
#[derive(CandidType, Deserialize)]
pub enum ChunkResult { ok(ChunkContent), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub enum CollectionResult { ok(CollectionInfo), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub enum OrigynBoolResult { ok(bool), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub enum DIP721BoolResult { Ok(bool), Err(NftError) }
...
#[derive(CandidType, Deserialize)]
pub enum DIP721TokensListMetadata { Ok(Vec<candid::Nat>), Err(NftError) }
...
#[derive(CandidType, Deserialize)]
pub enum DIP721TokensMetadata { Ok(Vec<TokenMetadata>), Err(NftError) }

#[derive(CandidType, Deserialize)]
pub enum OwnerOfResponse { Ok(Option<Principal>), Err(NftError) }
...
#[derive(CandidType, Deserialize)]
pub enum DIP721SupportedInterface { Burn, Mint, Approval, TransactionHistory }

#[derive(CandidType, Deserialize)]
pub enum DIP721TokenMetadata { Ok(TokenMetadata), Err(NftError) }

#[derive(CandidType, Deserialize)]
pub enum DIP721NatResult { Ok(candid::Nat), Err(NftError) }
...
#[derive(CandidType, Deserialize)]
pub enum CanisterLogFeature { filterMessageByContains, filterMessageByRegex }
...
#[derive(CandidType, Deserialize)]
pub enum MetricsGranularity { hourly, daily }
...
#[derive(CandidType, Deserialize)]
pub struct NumericEntity { avg: u64, max: u64, min: u64, first: u64, last: u64 }
...
#[derive(CandidType, Deserialize)]
pub struct CanisterMetrics { data: CanisterMetricsData }

#[derive(CandidType, Deserialize)]
pub enum OrigynTextResult { ok(String), err(OrigynError) }

#[derive(CandidType, Deserialize)]
pub enum GovernanceRequest {
  update_system_var{ key: String, val: Box<CandyShared>, token_id: String },
...
#[derive(CandidType, Deserialize)]
pub enum GovernanceResult { ok(GovernanceResponse), err(OrigynError) }

#[derive(CandidType, Deserialize)]
pub enum HistoryResult { ok(Vec<TransactionRecord>), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub struct Account__2 { owner: Principal, subaccount: Option<Subaccount> }
...
#[derive(CandidType, Deserialize)]
pub enum ApprovalResult { Ok(candid::Nat), Err(ApprovalError) }
...
#[derive(CandidType, Deserialize)]
pub struct SupportedStandard { url: String, name: String }
...
pub enum TransferError {
  ...
  Unauthorized{ token_ids: Vec<candid::Nat> },
...
#[derive(CandidType, Deserialize)]
pub enum ManageStorageResult { ok(ManageStorageResponse), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub struct MarketTransferRequest { token_id: String, sales_config: SalesConfig }
...
pub enum EXTMetadata {
  ...
  nonfungible{ metadata: Option<serde_bytes::ByteBuf> },
}

#[derive(CandidType, Deserialize)]
pub enum EXTMetadataResult { ok(EXTMetadata), err(EXTCommonError) }
...
#[derive(CandidType, Deserialize)]
pub enum NFTInfoResult { ok(NFTInfoStable), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub enum TokenSpecFilter_filter_type { allow, block }
...
#[derive(CandidType, Deserialize)]
pub enum TokenIDFilter_filter_type { allow, block }
...
#[derive(CandidType, Deserialize)]
pub struct DistributeSaleRequest { seller: Option<Account> }
...
#[derive(CandidType, Deserialize)]
pub enum ManageSaleResult { ok(Box<ManageSaleResponse>), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub enum SaleInfoResult { ok(SaleInfoResponse), err(OrigynError) }

#[derive(CandidType, Deserialize)]
pub struct ShareWalletRequest { to: Account, token_id: String, from: Account }
...
#[derive(CandidType, Deserialize)]
pub enum OwnerUpdateResult { ok(OwnerTransferResponse), err(OrigynError) }
...
#[derive(CandidType, Deserialize)]
pub struct StageLibraryResponse { canister: Principal }

#[derive(CandidType, Deserialize)]
pub enum StageLibraryResult { ok(StageLibraryResponse), err(OrigynError) }

#[derive(CandidType, Deserialize)]
pub struct Nft_Canister_stage_nft_origyn_arg0 { metadata: Box<CandyShared> }
...
#[derive(CandidType, Deserialize)]
pub enum StorageMetricsResult { ok(StorageMetrics), err(OrigynError) }
...
pub struct EXTTokensResponse (
  u32,Option<EXTTokensResponse_1_inner>,Option<serde_bytes::ByteBuf>,
);

#[derive(CandidType, Deserialize)]
pub enum EXTTokensResult { ok(Vec<EXTTokensResponse>), err(EXTCommonError) }
...
#[derive(CandidType, Deserialize)]
pub enum EXTTransferResponse { ok(EXTBalance), err(EXTTransferResponse_err) }
...
#[derive(CandidType, Deserialize)]
pub struct UpdateShared { mode: UpdateModeShared, name: String }

#[derive(CandidType, Deserialize)]
pub struct UpdateRequestShared { id: String, update: Vec<Box<UpdateShared>> }

#[derive(CandidType, Deserialize)]
pub enum NFTUpdateRequest {
  update{ token_id: String, update: UpdateRequestShared, app_id: String },
  replace{ token_id: String, data: Box<CandyShared> },
}

pub type NFTUpdateResponse = bool;
#[derive(CandidType, Deserialize)]
pub enum NFTUpdateResult { ok(NFTUpdateResponse), err(OrigynError) }
...
impl SERVICE {
  pub async fn __advance_time(&self, arg0: candid::Int) -> Result<
    (candid::Int,)
  ...
  pub async fn back_up(&self, arg0: candid::Nat) -> Result<
    (Nft_Canister_back_up_ret0,)
  > { ic_cdk::call(self.0, "back_up", (arg0,)).await }
  pub async fn balance(&self, arg0: EXTBalanceRequest) -> Result<
    (EXTBalanceResult,)
  > { ic_cdk::call(self.0, "balance", (arg0,)).await }
  pub async fn balanceEXT(&self, arg0: EXTBalanceRequest) -> Result<
    (EXTBalanceResult,)
  > { ic_cdk::call(self.0, "balanceEXT", (arg0,)).await }
  pub async fn balance_of_batch_nft_origyn(&self, arg0: Vec<Account>) -> Result<
    (Vec<BalanceResult>,)
  > { ic_cdk::call(self.0, "balance_of_batch_nft_origyn", (arg0,)).await }
  pub async fn balance_of_nft_origyn(&self, arg0: Account) -> Result<
    (BalanceResult,)
  ...
  pub async fn balance_of_secure_nft_origyn(&self, arg0: Account) -> Result<
    (BalanceResult,)
  > { ic_cdk::call(self.0, "balance_of_secure_nft_origyn", (arg0,)).await }
  pub async fn bearer(&self, arg0: EXTTokenIdentifier) -> Result<
    (EXTBearerResult,)
  > { ic_cdk::call(self.0, "bearer", (arg0,)).await }
  pub async fn bearerEXT(&self, arg0: EXTTokenIdentifier) -> Result<
    (EXTBearerResult,)
  > { ic_cdk::call(self.0, "bearerEXT", (arg0,)).await }
  pub async fn bearer_batch_nft_origyn(&self, arg0: Vec<String>) -> Result<
    (Vec<BearerResult>,)
  ...
  pub async fn bearer_nft_origyn(&self, arg0: String) -> Result<
    (BearerResult,)
  > { ic_cdk::call(self.0, "bearer_nft_origyn", (arg0,)).await }
  pub async fn bearer_secure_nft_origyn(&self, arg0: String) -> Result<
    (BearerResult,)
  ...
  pub async fn chunk_nft_origyn(&self, arg0: ChunkRequest) -> Result<
    (ChunkResult,)
  > { ic_cdk::call(self.0, "chunk_nft_origyn", (arg0,)).await }
  pub async fn chunk_secure_nft_origyn(&self, arg0: ChunkRequest) -> Result<
    (ChunkResult,)
  ...
  pub async fn dip721_balance_of(&self, arg0: Principal) -> Result<
    (candid::Nat,)
  ...
  pub async fn dip721_operator_token_metadata(&self, arg0: Principal) -> Result<
    (DIP721TokensMetadata,)
  > { ic_cdk::call(self.0, "dip721_operator_token_metadata", (arg0,)).await }
  pub async fn dip721_owner_of(&self, arg0: candid::Nat) -> Result<
    (OwnerOfResponse,)
  > { ic_cdk::call(self.0, "dip721_owner_of", (arg0,)).await }
  pub async fn dip721_owner_token_identifiers(&self, arg0: Principal) -> Result<
    (DIP721TokensListMetadata,)
  > { ic_cdk::call(self.0, "dip721_owner_token_identifiers", (arg0,)).await }
  pub async fn dip721_owner_token_metadata(&self, arg0: Principal) -> Result<
    (DIP721TokensMetadata,)
  ...
  pub async fn dip721_supported_interfaces(&self) -> Result<
    (Vec<DIP721SupportedInterface>,)
  ...
  pub async fn dip721_token_metadata(&self, arg0: candid::Nat) -> Result<
    (DIP721TokenMetadata,)
  ...
  pub async fn getCanisterMetrics(&self, arg0: GetMetricsParameters) -> Result<
    (Option<CanisterMetrics>,)
  ...
  pub async fn get_nat_as_token_id_origyn(&self, arg0: candid::Nat) -> Result<
    (String,)
  > { ic_cdk::call(self.0, "get_nat_as_token_id_origyn", (arg0,)).await }
  pub async fn get_token_id_as_nat_origyn(&self, arg0: String) -> Result<
    (candid::Nat,)
  ...
  pub async fn governance_nft_origyn(&self, arg0: GovernanceRequest) -> Result<
    (GovernanceResult,)
  ...
  pub async fn icrc7_approve(&self, arg0: ApprovalArgs) -> Result<
    (ApprovalResult,)
  > { ic_cdk::call(self.0, "icrc7_approve", (arg0,)).await }
  pub async fn icrc7_balance_of(&self, arg0: Account__2) -> Result<
    (candid::Nat,)
  > { ic_cdk::call(self.0, "icrc7_balance_of", (arg0,)).await }
  pub async fn icrc7_collection_metadata(&self) -> Result<
    (CollectionMetadata,)
  ...
  pub async fn icrc7_metadata(&self, arg0: candid::Nat) -> Result<
    (Vec<(String,Metadata,)>,)
  ...
  pub async fn icrc7_owner_of(&self, arg0: candid::Nat) -> Result<
    (Account__2,)
  ...
  pub async fn icrc7_supported_standards(&self) -> Result<
  ...
  pub async fn icrc7_tokens_of(&self, arg0: Account__2) -> Result<
    (Vec<candid::Nat>,)
  ...
  pub async fn icrc7_transfer(&self, arg0: TransferArgs) -> Result<
    (TransferResult,)
  ...
  pub async fn metadataExt(&self, arg0: EXTTokenIdentifier) -> Result<
    (EXTMetadataResult,)
  ...
  pub async fn mint_nft_origyn(&self, arg0: String, arg1: Account) -> Result<
    (OrigynTextResult,)
  ...
  pub async fn nft_batch_origyn(&self, arg0: Vec<String>) -> Result<
    (Vec<NFTInfoResult>,)
  > { ic_cdk::call(self.0, "nft_batch_origyn", (arg0,)).await }
  pub async fn nft_batch_secure_origyn(&self, arg0: Vec<String>) -> Result<
    (Vec<NFTInfoResult>,)
  ...
  pub async fn nft_secure_origyn(&self, arg0: String) -> Result<
    (NFTInfoResult,)
  > { ic_cdk::call(self.0, "nft_secure_origyn", (arg0,)).await }
  pub async fn operaterTokenMetadata(&self, arg0: Principal) -> Result<
    (DIP721TokensMetadata,)
  ...
  pub async fn ownerTokenMetadata(&self, arg0: Principal) -> Result<
    (DIP721TokensMetadata,)
  ...
  pub async fn sale_info_nft_origyn(&self, arg0: SaleInfoRequest) -> Result<
    (SaleInfoResult,)
  ...
  pub async fn stage_library_nft_origyn(&self, arg0: StageChunkArg) -> Result<
    (StageLibraryResult,)
  ...
  pub async fn storage_info_nft_origyn(&self) -> Result<
    (StorageMetricsResult,)
  > { ic_cdk::call(self.0, "storage_info_nft_origyn", ()).await }
  pub async fn storage_info_secure_nft_origyn(&self) -> Result<
    (StorageMetricsResult,)
  ...
  pub async fn transfer(&self, arg0: EXTTransferRequest) -> Result<
    (EXTTransferResponse,)
  ...
  pub async fn transferEXT(&self, arg0: EXTTransferRequest) -> Result<
    (EXTTransferResponse,)
  ...
  pub async fn update_app_nft_origyn(&self, arg0: NFTUpdateRequest) -> Result<
    (NFTUpdateResult,)
...
pub const gld_nft: SERVICE = SERVICE(Principal::from_slice(&[0, 0, 0, 0, 1, 80, 17, 132, 1, 1])); // obapm-2iaaa-aaaak-qcgca-cai